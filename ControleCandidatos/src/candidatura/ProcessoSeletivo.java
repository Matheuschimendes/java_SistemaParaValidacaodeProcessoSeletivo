...
public class ProcessoSeletivo {
    public static void main(String[] args) {
        ...
        String[] candidatos = { "Rafael", "Lucas", "Mirela" };
    ...
    static void selecaoCandidatos() {
        String[] candidatos = { "Felipe", "Matheus", "Gustavo", "Monica", "Rafael", "Lucas", "Mirela" };
        ...
        while (candidatosSelecionados < 5 && candidatosAtual < candidatos.length) {
            ...
            System.out.println("O cadidato " + candidato + " Solicitou este valor de salario " + salarioPretendido );
            if (salarioBase >= salarioPretendido) {
                System.out.println("O candidato " + candidato + " foi selecionado para a vaga");
                System.out.println("Ligar para o canditado");
                candidatosSelecionados++;
            } else if (salarioBase <= salarioBase) {
                System.out.println("Canditado " + candidato + " NÃO FOI SELECIONADO" );
